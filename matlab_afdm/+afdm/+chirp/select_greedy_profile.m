...
%SELECT_GREEDY_PROFILE Apply grouped greedy PAPR selection for a scheme.
    ...
    oversamplingFactor = afdm.chirp.get_param( ...
        config.pre_chirp, 'oversampling_factor', 1);

    baseProfile = afdm.chirp.build_profile(scheme, N, config.pre_chirp);
    selection = afdm.search.greedy_group_papr_selection( ...
        symbols, ...
        N, ...
        c1, ...
        baseProfile.candidate_set, ...
        baseProfile.group_index, ...
        oversamplingFactor);
